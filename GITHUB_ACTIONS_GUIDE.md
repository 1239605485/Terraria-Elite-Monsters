...
6. 将下载得到的 ZIP 导入 TEFManager，确认安装的是 0.7.0 原版奖励版。

本版本的旅途、经典、专家、大师、传奇模式概率均为 100%，精英怪名称显示红色“【精英】”标识，并按精英等级提高原版金币奖励。测试完成后，将 `EliteMonsters/mod.c` 中的概率数组改回正式值并重新运行 Actions：
