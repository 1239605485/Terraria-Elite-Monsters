# EliteMonsters 2.0.0-alpha5-passive-rule-batch1-fix 第一批世界规则效果
...
vanilla AI behavior.
Version 2.0.0-alpha5-passive-rule-batch1-fix installs the minimal NPC `SetDefaults` hook plus
