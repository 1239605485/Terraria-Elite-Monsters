# EliteMonsters 1.3.0 正式版（liuxin 四档难度、词缀与进度奖励版）
...
Version 1.3.0 adds six visible affixes. Flame increases damage and periodically
...
better client/server agreement. SetDefaults hooks use a pre/post depth guard, and
