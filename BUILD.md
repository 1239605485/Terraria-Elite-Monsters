# EliteMonsters 2.0.0-alpha5-passive-rule-batch1-test-100spawn 夜行猎杀测试版
...
vanilla AI behavior.
Version 2.0.0-alpha5-passive-rule-batch1-test-100spawn installs the minimal NPC `SetDefaults` hook plus
...
The first gameplay batch enables only the Night Hunt rule's night-time elite
damage multiplier, and leaves all other world-rule effects disabled.
It does not install
