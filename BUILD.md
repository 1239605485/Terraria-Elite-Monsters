# EliteMonsters 2.0.0-alpha4.3-safe-noui-terrain-observe 模块化增量验证版
...
vanilla AI behavior.
Version 2.0.0-alpha4.3-safe-noui-terrain-observe installs the minimal NPC `SetDefaults` hook plus
