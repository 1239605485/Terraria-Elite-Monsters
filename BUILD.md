# EliteMonsters 1.3.3 正式版（liuxin 双层变异规则版）
...
version. Version 1.3.3 also resolves the vanilla `Terraria.Main.NewText`
...
installable package. Version 1.3.3 directly asks TEFKernel to hook the known
...
Version 1.3.3 keeps a world-scoped list of 3--5 unique global rules and a
