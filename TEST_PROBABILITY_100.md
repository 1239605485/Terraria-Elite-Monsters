# EliteMonsters 0.6.0：100% 概率与红色名称修复版

本测试版将旅途、经典、专家、大师、传奇五种世界模式的精英怪生成概率都设置为 100%，并修复了 `NPC.SetDefaults` Hook 的执行时机和重载选择问题。名称源和 `Main.MouseText` 绘制入口都做了处理，鼠标悬停 NPC 时精英怪名称应显示为红色，并带有“【精英】”标识。
